...
# 各工程详细信息
**videoconvertor**（视频转换应用）：使用 **Qt** 和 **FFmpeg** 开发的一个简单的视频转换程序。本工程的详细讲解文章地址 [使用Qt和FFmpeg开发（音）视频格式转换应用](https://www.toutiao.com/article/7246269121116291596/?log_from=669ecc3e0edf7_1687165182594) 。
